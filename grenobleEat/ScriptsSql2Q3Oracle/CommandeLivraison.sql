...
SELECT  max(idCommande)+1, sysdate, sysdate, 1, 'attente de confirmation', 'livraison' 
from Commande;
...
SELECT  max(idCommande),"adresse de livraison donnée par l'utilisateur" ,'i have ran into some traffic i will be there 5 min late',sysdate
from Commande;
